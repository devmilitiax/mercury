...
<?php include('sidebarmenu.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Mercury Launcher
        <small>Central manager for mass releases.</small>
      </h1>
      <ol class="breadcrumb">
...
$(document).ready(function(){
   ...
   $("#SearchAdvertising").select2({
      ajax: {
        url: "extract_advertising_list.php",
        type: "post",
        dataType: 'json',
        delay: 250,
   ...
   $("#SearchRecipients").select2({
      ajax: {
        url: "extract_recipient_list.php",
        type: "post",
        dataType: 'json',
        delay: 250,
        data: function (params) {
