...
<head>
  ...
  <meta name="author" content="www.devmilitiax.com">
  <meta property="og:title" content="Mercury Launcher">
  <meta name="description" content="EMAIL BULK SOFTWARE">
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        SMTP
        <small>Manage the SMTP that sends emails here.</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
		<object data="cruddiy-202312.1_smtp/core/app/smtp-index.php" type="text/html"  style="width:100%;height:600px;"></object>
		We recommend that you create a new SMTP account to use in Mercury,
		<strong>YOU SHOULD NOT USE YOUR PERSONAL OR BUSINESS EMAIL!</strong>
		We recommend creating a new account, as the associated account doesn't have to be your business's official webmail or Gmail account.
