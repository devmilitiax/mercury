...
<?php include('sidebarmenu.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Newsletters
        <small>Click on the Template name to edit visually</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
		<object data="cruddiy-202312.1/core/app/newsletters-index.php" type="text/html" style="width:100%;height:500px;"></object>
