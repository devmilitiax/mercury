...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['editores']['columns'])) {
        foreach ($tables_and_columns_names['editores']['columns'] as $columnName => $columnDetails) {
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if (!isset($error)){
            ...
            header("location: editores-index.php");
        }
    }
