...
<head>
<meta charset="utf-8">
<title>Import from XLS or XLSX file</title>
</head>
...
<div id="insert_csv" class="form-inline"><form method="post" action="excel_tabla.php" enctype="multipart/form-data">
	<table>
    	<tr><td colspan="2"><h3>Importing from a XLS/XLSX file</h3></td></tr>
        <tr><td>Select Table: </td><td><?php include("../resources/tablas.php")?></td></tr>
        <tr id="m_arch"><td>Select File: </td><td><input type="file" id="archivo_excel" name="archivo_excel"></td></tr>
