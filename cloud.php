...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Nube Free
        <small>Administra aqui los archivos multimedia.</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Nube Free</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
		<object data="nube_free" type="text/html"  style="width:100%;height:1000px;"></object>
		Recuerda que tu nube free almacena los archivos en el servicio publico de IMGUR,
		<strong>NO DEBES ALMACENAR AQUI FOTOS INTIMAS O PRIVADAS.</strong>
